...
typedef enum
{
    ...
    LVM_FS_192000 = 10,
#endif
    LVM_FS_INVALID = LVM_MAXIMUM-1,
    LVM_FS_DUMMY = LVM_MAXIMUM
} LVM_Fs_en;
...
typedef enum
{
    ...
    LVM_MEMORYTYPE_DUMMY        = LVM_MAXIMUM
} LVM_MemoryTypes_en;
