...
typedef enum
{
    ...
    LVCS_COEFFICIENT    = 2,
    LVCS_PERSISTENT     = 3,
    LVCS_MEMORYTYPE_MAX = LVM_MAXIMUM
} LVCS_MemoryTypes_en;
...
typedef enum
{
    ...
    LVCS_TOO_MANY_SAMPLES = 3,                        /* Maximum block size exceeded */
    LVCS_INVALIDBUFFER  = 4,                        /* Invalid buffer processing request */
    LVCS_STATUSMAX      = LVM_MAXIMUM
...
typedef enum
{
    ...
    LVCS_SPEAKERTYPE_MAX        = LVM_MAXIMUM
} LVCS_SpeakerType_en;
