...
dp_state String8::setTo(const char* other)
{
...
dp_state String8::setTo(const char* other, size_t len)
{
...
dp_state String8::setTo(const char16_t* other, size_t len)
{
...
dp_state String8::setTo(const char32_t* other, size_t len)
{
...
dp_state String8::append(const String8& other)
{
...
dp_state String8::append(const char* other)
{
    return append(other, strlen(other));
}

dp_state String8::append(const char* other, size_t otherLen)
{
    if (bytes() == 0) {
...
dp_state String8::appendFormat(const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);

    dp_state result = appendFormatV(fmt, args);

    va_end(args);
    return result;
}

dp_state String8::appendFormatV(const char* fmt, va_list args)
{
...
dp_state String8::real_append(const char* other, size_t otherLen)
{
...
dp_state String8::unlockBuffer(size_t size)
{
    if (size != this->size()) {
        SharedBuffer* buf = SharedBuffer::bufferFromData(mString)
            ->editResize(size+1);
